  ...
  <div style="position:absolute;bottom: 10px;width:100%;top:50px;">
    ...
    <div style="height:100%;">
      ...
      <div style="width:74%;height: 100%;float: right;">
        <!--用户信息-->
        <div
          style="width: 79%;height: 100px;border: 1px solid rgb(209, 219, 229);text-align: center;padding-left: 30px;padding-top: 30px;box-shadow: 0 2px 4px 0 rgba(0,0,0,.12), 0 0 6px 0 rgba(0,0,0,.04);"
        >
          <div style="float: left;width: 150px;height:100px;">
            ...
            <div style="float:right;width: 80px;">
              ...
              <div
                style="border-radius: 5px;background-color: #20a0ff;color: #FFFFFF;font-weight: bold;margin-top: 15px;"
              >已认证</div>
            </div>
          </div>
          <div style="float: right;width:210px;">
            <div style="float: left;margin-top: 11px;">发布跟单</div>
            <el-switch v-model="publishOrder" active-color="#13ce66" inactive-color="#ff4949"></el-switch>
    ...
    margin-top: 5px;
    font-weight: BOLD;"
              >{{(selectUser.balance/100).toFixed(2)}}</div>
            </div>
            <div class="userOpera">
